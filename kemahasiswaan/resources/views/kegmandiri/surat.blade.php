...
<body>
    ...
    <div id="halaman">
        ...
        <p>Sehubungan dengan akan dilaksanakannya kegiatan {{$mandiri->url_kegiatan}} pada tanggal {{$mandiri->tanggal_mulai}}
            s.d {{$mandiri->tanggal_selesai}}, dengan ini saya mohon
        ...
        <table id="tabel">
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$mandiri->nim}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Nama</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$mandiri->nama}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Kategori Kegiatan</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$mandiri->kategori_kegiatan}}</td>
            </tr>
